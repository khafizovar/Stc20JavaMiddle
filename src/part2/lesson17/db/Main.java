...
import part2.lesson17.db.dao.GenericDao;
import part2.lesson17.db.dao.RoleDao;
import part2.lesson17.db.dao.UserDao;
import part2.lesson17.db.dao.UserRoleDao;
...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        GenericDao<User> userDao = new UserDao(connectionManager);
        GenericDao<Role> roleDao = new RoleDao(connectionManager);
        GenericDao<UserRole> urDao = new UserRoleDao(connectionManager);
        ...
        userDao.add(new User(-1, "Иванов Иван Иванович",
                ...
                "user1@notreal.ru",
                "user1 description"));
        userDao.add(new User(-1, "Сидоров Сидор Сидорович",
                LocalDate.of(1980, Month.AUGUST, 3),
                "user2",
                "Montreal",
                "user2@notreal.ru",
                "user2 description"));
        userDao.add(new User(-1, "Олегов Олег Олегович",
        ...
        userDao.add(new User(-1, "Петрова Василиса Прекрасновна",
        ...
        conn.setAutoCommit(false);
        userDao.add(new User(-1, "Сидорова Василиса Премудровна",
